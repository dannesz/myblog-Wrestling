                    ...
                    <tbody>
                        ...
                        @foreach ($posts as $post)
                            ...
                            <tr>
                                ...
                                <td>{{ $post->title }}</td>
                                <td>
                                    <img src="{{ asset( $post->featured ) }}" alt="{{ $post->featured }}" class="img-fluid img-thumbnail" width="100px">
                                </td>
                                <td>

                                    
                                    <button type="button" class="btn btn-warning float-left mr-1" data-toggle="modal" data-target="#modal-update-post-{{$post->id}}">
                                        Editar
                                    </button>
                                    ...
                                    <form action="{{route('admin.posts.delete', $post->id)}}" method="POST">
                                        {{ csrf_field() }}
                                        @method('DELETE')
                                        <button class="btn btn-danger float-left mr-1">Eliminar</button>
                                    </form>
